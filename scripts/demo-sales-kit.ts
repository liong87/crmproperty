 ...
 *       ...with no argument it fills the most recently created project.
 *
...
const KIT: Item[] = [
  ...
  { category: "price-list", label: "Selling Price List (current)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER", notes: "Supersedes every earlier copy. Check the date before quoting." },
  { category: "price-list", label: "Phase Layout Plan", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  ...
  // Legal & licensing
  { category: "legal", label: "APDL", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "legal", label: "Lesen Pemaju (Developer Licence)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "legal", label: "Master Title", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  ...
  // Marketing material
  { category: "marketing", label: "E-Brochure", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "marketing", label: "Photo Gallery", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },

  // Blank forms — the templates an agent gives a buyer
  { category: "forms", label: "Sales Form (blank)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER", notes: "The buyer's completed copy belongs on their deal, not here." },
  { category: "forms", label: "Consent Letter (blank)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "forms", label: "Cancellation Form (blank)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "forms", label: "Change Unit Form (blank)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  { category: "forms", label: "BGB Form (blank)", url: "https://drive.google.com/drive/folders/REPLACE-WITH-YOUR-FOLDER" },
  ...
  // Showroom & logistics
  { category: "logistics", label: "Showroom Location", url: "https://maps.app.goo.gl/REPLACE-WITH-YOUR-PIN", notes: "Send this to the buyer the day before the appointment." },
...
async function main() {
  ...
  console.log("Placeholder links read REPLACE-WITH-YOUR-FOLDER — swap them for real ones, or delete the demo items when you are done looking.");
  process.exit(0);
}
